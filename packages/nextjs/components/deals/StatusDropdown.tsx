...
export function StatusDropdown({ status, setStatus }: StatusDropdownProps) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="inline-flex w-28 justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold text-neutral shadow-sm ring-1 ring-inset ring-accent-content hover:bg-gray-50 bg-white">
          {status || "Status"}
